<?php 
    ...
    if(isset($_POST['login'])){
        ...
        if($result->num_rows==1 && $_SESSION['role']=='receptionist'){
            header('location:receptionist/dashboard.php');
        } else {
            $msg = "Invalid Receptionist Login credentials!";
        }
    }
?>
<!DOCTYPE html>
...
<body>
    <div class="justify-center min-h-screen px-4 py-1 bg-gray-50 sm:px-6 lg:px-8">
      <div class="w-full max-w-xs p-8 mx-auto mt-10 space-y-10 bg-white shadow rounded-xl">
        <div>
          <h2 class="mt-6 text-2xl font-extrabold text-center text-gray-900">Receptionist Login</h2>
